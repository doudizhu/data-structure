...
// isbool = arrA.every((element,index,array)=>{
//     return element < 1;
// })
// console.log(isbool);
...
console.log(arrA.lastIndexOf(2));
...
// reverse 颠倒数组中的元素顺序，原先第一个元素现在变成最后一个，同样原先的最后一个元素变成现在了现在的第一个
console.log(a.reverse());

// toString 将数组作为字符串返回
console.log(arrA.toString());

// valueOf 和 toString 类似，将数组作为字符串返回 (? 好像不类似呀)
